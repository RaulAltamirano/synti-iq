...
export const REFERRAL_SPAN_NAMES = {
  ...
  FIND_BY_BUSINESS_PROFILE: SPAN_REFERRAL_FIND_BY_BUSINESS_PROFILE,
  ENSURE_CODE: SPAN_REFERRAL_ENSURE_CODE,
...
export const REFERRAL_SPAN_ATTRIBUTES = {
  OPERATION: ATTR_REFERRAL_OPERATION,
  ...
  USER_ROLE: ATTR_REFERRAL_USER_ROLE,
