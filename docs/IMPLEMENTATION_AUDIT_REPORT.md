...
Re-audit of the full quality and automation implementation. Date: 2025-03-19.
...
| Template-specific constant names | docs/prompts/new-module.md | TEMPLATE_* → `<MODULE>_*` placeholder + reference to template file |
