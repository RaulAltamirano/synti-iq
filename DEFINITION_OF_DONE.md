...
| Criterion                                                                                                      | Source                                  | Verification                                                                                   |
| -------------------------------------------------------------------------------------------------------------- | --------------------------------------- | ---------------------------------------------------------------------------------------------- |
| Conventional commit messages                                                                                   | commitlint, DEVELOPMENT_WORKFLOW        | feat/fix/refactor/test/chore prefix; commit-msg hook                                           |
...
| **ADR created if:** (a) new technology/dependency, (b) change of documented pattern, (c) multi-module decision | docs/adr/000-index.md, adr-checklist.md | Check docs/adr/ for new files; use [adr-checklist.md](docs/prompts/adr-checklist.md) to decide |
